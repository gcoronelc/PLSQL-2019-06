...
--CREATE SCHEMA AUTHORIZATION EVENTO_GSTR

CREATE TABLE GSTR_INFO_EVENTO
(
  INFO_CODIGO          INTEGER NOT NULL ,
  INFO_NOMBRE          VARCHAR(100) NULL ,
  INFO_FEC_INICIO      DATE NULL ,
  INFO_FEC_FIN         DATE NULL ,
  INFO_LUGAR           VARCHAR2(150) NULL ,
  INFO_SALA            VARCHAR2(150) NULL ,
  INFO_CAPACIDAD       INTEGER NULL ,
  INFO_INVERSION       NUMERIC(18,2) NULL ,
  INFO_NUM_EXPOSITORES INTEGER NULL ,
  INFO_NUM_STANDS      INTEGER NULL 
);

CREATE UNIQUE INDEX XPKGSTR_INFO_EVENTO ON GSTR_INFO_EVENTO
(INFO_CODIGO   ASC);

ALTER TABLE GSTR_INFO_EVENTO
  ADD CONSTRAINT  XPKGSTR_INFO_EVENTO PRIMARY KEY (INFO_CODIGO);

CREATE TABLE GSTR_PARAMETRO
(
  PARM_CODIGO          INTEGER NOT NULL ,
  PARM_CODPADRE        INTEGER NULL ,
  PARM_ID              VARCHAR2(100) NULL ,
  PARM_DESCRIPCION     VARCHAR2(1000) NULL ,
  PARM_ABREVIATURA     VARCHAR2(1000) NULL ,
  PARM_USU_CREACION    VARCHAR2(50) NULL ,
  PARM_FEC_CREACION    DATE NULL ,
  PARM_USU_MODIFICACION VARCHAR2(50) NULL ,
  PARM_FEC_MODIFICACION DATE NULL ,
  PARM_ESTADO          CHAR(1) NULL ,
  TIPP_CODIGO          CHAR(18) NULL 
);

CREATE UNIQUE INDEX XPKGSTR_PARAMETRO ON GSTR_PARAMETRO
(PARM_CODIGO   ASC);

ALTER TABLE GSTR_PARAMETRO
  ADD CONSTRAINT  XPKGSTR_PARAMETRO PRIMARY KEY (PARM_CODIGO);

CREATE TABLE GSTR_PARTICIPACION
(
  PART_CODIGO          INTEGER NOT NULL ,
  PART_PREGUNTA        VARCHAR2(150) NULL ,
  PART_RESPUESTA       VARCHAR2(300) NULL ,
  PART_FLAG_RESPONDIDO CHAR(1) NULL ,
  PART_FLAG_ANULADO    CHAR(1) NULL ,
  PART_FEC_PREGUNTA    DATE NULL ,
  PART_FEC_RESPUESTA   DATE NULL ,
  USU_COD_INVITADO     INTEGER NULL ,
  TEMA_CODIGO          INTEGER NULL 
);

CREATE UNIQUE INDEX XPKGSTR_PARTICIPACION ON GSTR_PARTICIPACION
(PART_CODIGO   ASC);

ALTER TABLE GSTR_PARTICIPACION
  ADD CONSTRAINT  XPKGSTR_PARTICIPACION PRIMARY KEY (PART_CODIGO);

CREATE TABLE GSTR_TEMAS
(
  TEMA_CODIGO          INTEGER NOT NULL ,
  TEMA_NOMBRE          VARCHAR2(150) NULL ,
  TEMA_FECHA           DATE NULL ,
  TEMA_HORA_INICIO     DATE NULL ,
  TEMA_HORA_FIN        DATE NULL ,
  USU_COD_EXPOSITOR    INTEGER NULL ,
  INFO_CODIGO          INTEGER NULL 
);

CREATE UNIQUE INDEX XPKGSTR_TEMAS ON GSTR_TEMAS
(TEMA_CODIGO   ASC);

ALTER TABLE GSTR_TEMAS
  ADD CONSTRAINT  XPKGSTR_TEMAS PRIMARY KEY (TEMA_CODIGO);

CREATE TABLE GSTR_TIPO_PARAMETRO
(
  TIPP_CODIGO          CHAR(18) NOT NULL ,
  TIPP_NOMBRE          CHAR(18) NULL ,
  TIPP_DESCRIPCION     CHAR(18) NULL ,
  TIPP_LONGITUD        CHAR(18) NULL ,
  TIPP_USU_CREACION    CHAR(18) NULL ,
  TIPP_FEC_CREACION    CHAR(18) NULL ,
  TIPP_USU_MODIFICACION CHAR(18) NULL ,
  TIPP_FEC_MODIFICACION CHAR(18) NULL ,
  TIPP_ESTADO          CHAR(18) NULL 
);

CREATE UNIQUE INDEX XPKGSTR_TIPO_PARAMETRP ON GSTR_TIPO_PARAMETRO
(TIPP_CODIGO   ASC);

ALTER TABLE GSTR_TIPO_PARAMETRO
  ADD CONSTRAINT  XPKGSTR_TIPO_PARAMETRP PRIMARY KEY (TIPP_CODIGO);

CREATE TABLE GSTR_USUARIO
(
  USU_CODIGO           INTEGER NOT NULL ,
  USU_NOMBRE           VARCHAR2(60) NULL ,
  USU_CARGO            VARCHAR2(100) NULL ,
  USU_EMPRESA          VARCHAR2(100) NULL ,
  USU_TELEFONO         VARCHAR2(50) NULL ,
  USU_CORREO           VARCHAR2(150) NULL ,
  USU_COD_QR           BLOB NULL ,
  USU_DETALLE          VARCHAR2(150) NULL ,
  PARM_COD_TIPO_USUARIO INTEGER NULL ,
  PARM_COD_PAIS        INTEGER NULL ,
  USU_DOCUMENTO        VARCHAR2(15) NULL ,
  PARM_COD_TIPO_DOCUMENTO INTEGER NULL 
);

CREATE UNIQUE INDEX XPKGSTR_USUARIO ON GSTR_USUARIO
(USU_CODIGO   ASC);

ALTER TABLE GSTR_USUARIO
  ADD CONSTRAINT  XPKGSTR_USUARIO PRIMARY KEY (USU_CODIGO);

ALTER TABLE GSTR_PARAMETRO
  ADD (CONSTRAINT R_9 FOREIGN KEY (TIPP_CODIGO) REFERENCES GSTR_TIPO_PARAMETRO (TIPP_CODIGO) ON DELETE SET NULL);

ALTER TABLE GSTR_PARTICIPACION
  ADD (CONSTRAINT R_6 FOREIGN KEY (USU_COD_INVITADO) REFERENCES GSTR_USUARIO (USU_CODIGO) ON DELETE SET NULL);

ALTER TABLE GSTR_PARTICIPACION
  ADD (CONSTRAINT R_8 FOREIGN KEY (TEMA_CODIGO) REFERENCES GSTR_TEMAS (TEMA_CODIGO) ON DELETE SET NULL);

ALTER TABLE GSTR_TEMAS
  ADD (CONSTRAINT R_4 FOREIGN KEY (USU_COD_EXPOSITOR) REFERENCES GSTR_USUARIO (USU_CODIGO) ON DELETE SET NULL);

ALTER TABLE GSTR_TEMAS
  ADD (CONSTRAINT R_5 FOREIGN KEY (INFO_CODIGO) REFERENCES GSTR_INFO_EVENTO (INFO_CODIGO) ON DELETE SET NULL);

ALTER TABLE GSTR_USUARIO
  ADD (CONSTRAINT R_10 FOREIGN KEY (PARM_COD_TIPO_USUARIO) REFERENCES GSTR_PARAMETRO (PARM_CODIGO) ON DELETE SET NULL);

ALTER TABLE GSTR_USUARIO
  ADD (CONSTRAINT R_11 FOREIGN KEY (PARM_COD_PAIS) REFERENCES GSTR_PARAMETRO (PARM_CODIGO) ON DELETE SET NULL);

ALTER TABLE GSTR_USUARIO
  ADD (CONSTRAINT R_13 FOREIGN KEY (PARM_COD_TIPO_DOCUMENTO) REFERENCES GSTR_PARAMETRO (PARM_CODIGO) ON DELETE SET NULL)
  ;

--SECUENCIALES
  
  CREATE SEQUENCE GSTR_USUARIO_Seq
  MINVALUE 1
  START WITH 1
  INCREMENT BY 1
  CACHE 20;
  
  CREATE SEQUENCE GSTR_TEMAS_Seq
  MINVALUE 1
  START WITH 1
  INCREMENT BY 1
  CACHE 20;
  
  CREATE SEQUENCE GSTR_INFO_EVENTO_Seq
  MINVALUE 1
  START WITH 1
  INCREMENT BY 1
  CACHE 20;
  
  CREATE SEQUENCE GSTR_PARTICIPACION_Seq
  MINVALUE 1
  START WITH 1
  INCREMENT BY 1
  CACHE 20;
  
  CREATE SEQUENCE GSTR_TIPO_PARAMETRO_Seq
  MINVALUE 1
  START WITH 1
  INCREMENT BY 1
  CACHE 20;
  
  CREATE SEQUENCE GSTR_PARAMETRO_Seq
  MINVALUE 1
  START WITH 1
  INCREMENT BY 1
  CACHE 20;
...
-- ESPECIFICACION / CABECERAS
create or replace 
package P_GASTRO_APP is
